...
- <img src="https://www.fractera.ai/favicon.ico" height="14"/> [Fractera](https://github.com/Fractera/ai-workspace) - Zero-Ops deploy of a private AI coding workspace (5 AI coding engines + an autonomous Hermes orchestrator + private LightRAG graph memory) onto your own Ubuntu VPS in about 10 minutes, straight from your AI chat. Remote MCP connector at https://www.fractera.ai/api/mcp (streamable-http, no auth).
